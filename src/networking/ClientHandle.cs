...
Mod.currentTNHInstance.manager.HoldPoints[Mod.currentTNHInstance.curHoldIndex].BeginHoldChallenge();
        ...
        public static void EncryptionNextPos(Packet packet)
        {
            int trackedID = packet.ReadInt();
        ...
        public static void EncryptionShieldRot(Packet packet)
        {
            int trackedID = packet.ReadInt();
        ...
        public static void SetModulWeaponPart(Packet packet)
        {
            int trackedID = packet.ReadInt();
