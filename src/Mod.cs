...
namespace H3MP
{
    ...
    public class Mod : BaseUnityPlugin
    {
        ...
        public static void InitTNHMenu()
        {
            ...
            H3MPHoverScroll upScroll = TNHInstanceListScrollUpArrow.AddComponent<H3MPHoverScroll>();
            H3MPHoverScroll downScroll = TNHInstanceListScrollDownArrow.AddComponent<H3MPHoverScroll>();
            ...
            upScroll = TNHPlayerListScrollUpArrow.AddComponent<H3MPHoverScroll>();
            downScroll = TNHPlayerListScrollDownArrow.AddComponent<H3MPHoverScroll>();
            upScroll.MaxPointingRange = 5;
            upScroll.scrollbar = TNHInstanceListScrollBar;
            upScroll.other = downScroll;
            upScroll.up = true;
        ...
        private void GetTrackedObjectTypes()
        {
            ...
            for (int i = 0; i < assemblies.Length; ++i)
            {
                if (assemblies[i].FullName.Split(',')[0].Equals("H3MP"))
                {
                    ...
                    AddTrackedType(typeof(TrackedBlisterData));
                    ...
                    AddTrackedType(typeof(TrackedSentinelData));
